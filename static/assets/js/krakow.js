window.onload = () => {
    ...
    const data = {
        ...
        boxes: [
            { alpha: 0, title: "march 17", titleX: 20 * vw, titleY: 30 * vh, text: "Avatar Challenge", textX: 20 * vw, textY: 33.5 * vh },
            { alpha: 0, title: "march 24", titleX: 45 * vw, titleY: 30 * vh, text: "AI Challenge", textX: 45 * vw, textY: 33.5 * vh },
            { alpha: 0, title: "march 31", titleX: 70 * vw, titleY: 30 * vh, text: "Under One Thousand\nCharacters Challenge", textX: 70 * vw, textY: 34.5 * vh },
            { alpha: 0, title: "april 3", titleX: 50 * vw, titleY: 47.75 * vh, text: "Escape Room Challenge", textX: 50 * vw, textY: 51.25 * vh },
            { alpha: 0, title: "april 7", titleX: 40 * vw, titleY: 70 * vh, text: "Crossfit Challenge", textX: 40 * vw, textY: 66 * vh },
            { alpha: 0, title: "april 14", titleX: 65 * vw, titleY: 70 * vh, text: "Finale", textX: 65 * vw, textY: 66 * vh },
            { alpha: 0, title: "april 28", titleX: 90 * vw, titleY: 70 * vh, text: "Awards Ceremony", textX: 90 * vw, textY: 66 * vh },
        ],
        dots: [
        ...
        update () {
            ...
            data.boxes.forEach(box => {
                if (box.alpha > 0) {
                    ...
                    textFont("league spartan bold", 4 * vmin);
                    text(box.title, box.titleX, box.titleY);
                    textFont("league spartan", 3 * vmin);
